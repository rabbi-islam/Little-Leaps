...
import com.example.littleleaps.WritingActivity
import com.example.littleleaps.WritingActivity.Companion.currentBrush
import com.example.littleleaps.cons.Ellipse
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        when (event.action) {
            MotionEvent.ACTION_DOWN -> {
                WritingActivity.colorList.add(WritingActivity.currentBrush)
